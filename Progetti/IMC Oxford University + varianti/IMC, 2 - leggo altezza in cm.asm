...
.data	
	...
	cento:			.float	100			# chiedo peso in [cm], divido poi per 100 per ottenere in [m]
	...
	s_ins_h:			.asciiz	"Inserisci l'altezza [cm]: "		
...
main:
	...
	l.s $f31, cento			# carico 100 per la divisione
	div.s $f10, $f10, $f31	# la divido per 100 per averla in m
